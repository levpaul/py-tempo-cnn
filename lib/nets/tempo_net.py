...
class TempoNet(nn.Module):
    def __init__(self, mfmod_levels):
        super(TempoNet, self).__init__()
        self.mfmod_levels = mfmod_levels
        ...
        mfmod_size = 205632 # Level = 1

        if self.mfmod_levels > 1:
            m=2
            input_chans=36
